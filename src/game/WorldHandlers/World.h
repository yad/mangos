...
enum eConfigUInt32Values
{
    ...
    // Easy-Mangos
    CONFIG_UINT32_PARANGON_MODE_LEVEL,
    // Warden
...
enum eConfigFloatValues
{
    ...
    // Easy-Mangos
    CONFIG_FLOAT_SPEED_GAME,
    CONFIG_FLOAT_RUN_SPEED_MULTIPLIER,
    CONFIG_FLOAT_SWIM_SPEED_MULTIPLIER,
    CONFIG_FLOAT_FLIGHT_SPEED_MULTIPLIER,
    CONFIG_FLOAT_ARMOR_MULTIPLIER,
    CONFIG_FLOAT_ATTACK_SPEED_MULTIPLIER,
    CONFIG_FLOAT_CATCH_UP_BONUS_XP_PER_CHARACTER,
    CONFIG_FLOAT_PARANGON_STATS_PER_LEVEL,
    CONFIG_FLOAT_REGEN_HEALTH,
    CONFIG_FLOAT_REGEN_POWER_MANA,
    CONFIG_FLOAT_REGEN_POWER_RAGE_INCOME,
    CONFIG_FLOAT_REGEN_POWER_RAGE_LOSS,
    CONFIG_FLOAT_REGEN_POWER_RUNICPOWER_INCOME,
    CONFIG_FLOAT_REGEN_POWER_RUNICPOWER_LOSS,
    CONFIG_FLOAT_REGEN_POWER_FOCUS,
    CONFIG_FLOAT_REGEN_POWER_ENERGY,
    CONFIG_FLOAT_REGEN_POWER_RUNES,
...
enum eConfigBoolValues
{
    ...
    // Easy-Mangos
    CONFIG_BOOL_NO_GLOBAL_COOLDOWN,
    CONFIG_BOOL_NO_CHECK_IN_FRONT,
    CONFIG_BOOL_NO_COST,
    CONFIG_BOOL_NO_WAIT_AFTER_CAST,
    CONFIG_BOOL_ALLOW_FLYING_MOUNTS_EVERYWHERE,
    CONFIG_BOOL_UNLIMITED_AMMO,
